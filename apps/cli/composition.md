...
flowchart LR
  ...
  plugin_dsh_base_skill_leila_ac["skill-leila-ac<br/>@deepseek-ai/dsh-skill-leila-ac"]
  cfg --> plugin_dsh_base_skill_leila_ac
...
| `skill-leila-ac` | `@deepseek-ai/dsh-skill-leila-ac` |
