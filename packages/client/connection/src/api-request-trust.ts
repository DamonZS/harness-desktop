 ...
 */
/**
 * Whether one request authority matches a configured trusted host entry.
 * @param hostUrl - parsed request authority.
 * @param trustedHosts - configured deployment authorities.
 * @returns true when the hostname or exact host and port match.
 */
